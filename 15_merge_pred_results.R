...
colcol<-read.table("~/mnt/agroscope_os/2/2/6/1/1/4/6021/GenSel_Costa_collab/R_output/20190701/predictions/COLLtoCOLL/accuracy_5fold_rrBLUP.txt", h=T)
...
CC$Model<-"NO_CLUST"
colcolcluster<-read.table("~/mnt/agroscope_os/2/2/6/1/1/4/6021/GenSel_Costa_collab/R_output/20190816/predictions/COLLtoCOLL/rrBLUPs_5fold_5clusters_fix.txt", h=T)
...
png(file=paste0(odir, "/predictions/COLtoCOL_modelsAB.png"), height=500, width=800)
...
scenario2<-readRDS("~/mnt/agroscope_os/2/2/6/1/1/4/6021/GenSel_Costa_collab/R_output/20190816/predictions/COLLtoFAMs_prop/all_traits_pred_progenies_0.3_prop100_reps.rds")
...
scenario3<-read.table("~/mnt/agroscope_os/2/2/6/1/1/4/6021/GenSel_Costa_collab/R_output/20190816/predictions/COLLtoFAMs_add_relFAM/rrBLUPs_aggregated.txt", h=T)
